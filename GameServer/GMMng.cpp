	...
	case 232://Identical
		...
		case 398:
		{
			...
			if(iTokenNumber == 4)
			{
				...
				{
					ItemSerialCreateSend(aIndex, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, ITEMGET(14,65), 0, 0, 0, 0, 0, -1, 0, 0); 
					ItemSerialCreateSend(aIndex, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, ITEMGET(14,66), 0, 0, 0, 0, 0, -1, 0, 0); 
					ItemSerialCreateSend(aIndex, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, ITEMGET(14,67), 0, 0, 0, 0, 0, -1, 0, 0); 
				}
			}
		}
		break;
...
//#endif
		...
		case 107:
		{
				...
				ItemIndex >= 0 && ItemIndex < 512)
			{
				...
				if(iItemNumber == ITEMGET(13,4) || iItemNumber ==  ITEMGET(13,5))
				{
					PetItemSerialCreateSend(aIndex, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, iItemNumber, EBP798, iDur, EBP79C, EBP7A0, EBP7A4, -1, EBP7A8, EBP7B4); 
				}
				else
				{
					ItemSerialCreateSend(aIndex, gObj[aIndex].MapNumber, gObj[aIndex].X, gObj[aIndex].Y, iItemNumber, EBP798, iDur, EBP79C, EBP7A0, EBP7A4, -1, EBP7A8, EBP7B4); 
